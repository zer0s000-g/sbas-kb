---
title: ASEAN SBAS Deployment Barriers
...
The hardest part of ASEAN SBAS may not be proving that the technology is useful.
The harder problem may be aligning multiple sovereign systems around a shared safety-critical service.
...
Why this matters:
- ASEAN sits in a low-latitude / equatorial environment where ionospheric irregularity and confidence modelling are likely more central than in a European comparison case
- this makes service credibility, integrity modelling, and rollout sequencing more demanding
- Empirical evidence now available: [[SBAS Ionospheric Threat — Empirical Evidence]], [[IRI-2020 vs GNSS-RO Indonesia]]
- Starter provenance scaffold: [[Source - Equatorial Ionosphere and SBAS Feasibility]]
...
- If the question is “why might the region want SBAS?”, use [[ASEAN SBAS Operational Demand Drivers]].
- If the question is “who would have to make it happen?”, use [[ASEAN SBAS Governance and Institutional Actors]].
- If the question is “what implementation pathway could work anyway?”, use [[ASEAN SBAS Service-Model Options]].

## Working conclusion
The ASEAN case is not blocked by one single barrier.
It is constrained by the combination of:
