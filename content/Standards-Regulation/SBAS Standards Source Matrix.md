...
1. [[Source - RTCA DO-229]] is the strongest current public-catalog-reviewed anchor for GPS/SBAS airborne equipment.
...
|---|---|---|---|
| [[Source - RTCA DO-229]] | RTCA GPS/SBAS airborne-equipment MOPS | Airborne receiver/equipment source-family anchor; LPV-capable equipment context; receiver-performance routing | SBAS ground-system certification, state approval, service availability, procedure minima, DFMC requirements unless specific revision supports them |
...
| ICAO Annex 10, Volume I | Not yet represented by a dedicated source note in this KB | Candidate future primary ICAO SARPs/technical baseline for GNSS/SBAS | Should not be paraphrased until a source note exists |
...
| Airborne SBAS equipment | RTCA/EUROCAE airborne equipment MOPS; regulator TSOs/ETSO material | DO-229 anchor improved | Link to DO-229 but avoid detailed requirements until extracted |
...
1. Create a dedicated source note for ICAO Annex 10, Volume I GNSS/SBAS material.
2. Directly extract [[Source - RTCA DO-229]] sections relevant to equipment classes, LPV/LP/LNAV/VNAV capability, alerting, and receiver integrity language.
